WOKWI_PROJECT_ID=340661930553246290
# A simple guess my number game
# The dip switch specifies a binary number,
# The 7-segment display says how far it is from the goal.
# When the goal is reached, it shows zero with a dot.
fetch:
